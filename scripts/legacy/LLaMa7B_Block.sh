prune_ckpt_path='llama_prune_0.2_without_tune_block_vectorize'
tune_ckpt_path='llama_prune_0.2_with_tune_block_vectorize'
...
prune_ckpt_path='llama_prune_0.2_without_tune_block_param_first'
tune_ckpt_path='llama_prune_0.2_with_tune_block_param_first'
echo "[START] - Start Pruning Model"
...
prune_ckpt_path='llama_prune_0.2_without_tune_block_param_mix'
tune_ckpt_path='llama_prune_0.2_with_tune_block_param_mix'
echo "[START] - Start Pruning Model"
...
#echo "[START] - Start Pruning Model"
#CUDA_VISIBLE_DEVICES=2 python hf_prune.py --pruning_ratio 0.2 --device cpu  --eval_device cuda --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 --block_attention_layer_start 4 --block_attention_layer_end 30 --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --test_after_train --taylor param_second --save_model
#echo "[FINISH] - Finish Pruning Model"
#echo "[START] - Start Tuning"

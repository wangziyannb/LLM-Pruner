...
echo "[START] - Start Pruning Model"
CUDA_VISIBLE_DEVICES=1 python hf_prune.py --pruning_ratio 0.2 --device cpu  --eval_device cuda --channel_wise --save_ckpt_log_name $prune_ckpt_path --pruner_type taylor --test_after_train --taylor vectorize --save_model
echo "[FINISH] - Finish Pruning Model"
